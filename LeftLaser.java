...
/**
 * A laser projectile that travels forward and to the left.
 * 
 * @author Alex Chang
 * @version Spring 2016
 */
public class LeftLaser extends Projectile
{
    ...
    /**
     * Constructor for the LeftLaser class. Plays the laser sound effect.
     */
    public LeftLaser()
    {
